...
Route::get('/lifestyle', [App\Http\Controllers\template\lifestyleController::class, 'index']);
Route::get('/travel', [App\Http\Controllers\template\travelController::class, 'index'])->name('about');
Route::get('/blog', [App\Http\Controllers\template\blogController::class, 'index'])->name('blog');
Route::get('/blog-details', [App\Http\Controllers\template\blogController::class, 'blog'])->name('blog');
Route::get('/ntf', [App\Http\Controllers\template\nftController::class, 'index'])->name('pricing');
